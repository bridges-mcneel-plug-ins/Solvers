...
namespace Solvers.Parameters
{
    ...
    internal class ParameterAttributes : GH_Ker.Attributes.GH_FloatingParamAttributes
    {
        ...
        #region Overrides : GH_FloatingParamAttributes
        ...
        protected override void Render(GH_Gui.GH_Canvas canvas, Graphics graphics, GH_Gui.GH_CanvasChannel channel)
        {
            if (channel == GH_Gui.GH_CanvasChannel.Objects)
            {
                ...
                GH_Gui.GH_Skin.palette_normal_standard = new GH_Gui.GH_PaletteStyle(Display.ColourPalette.LightBlue, Color.Black, Color.Black);
                GH_Gui.GH_Skin.palette_hidden_standard = new GH_Gui.GH_PaletteStyle(Display.ColourPalette.Blue, Color.Black, Color.Black);
