...
{
    /// <summary>
    /// A grasshopper component creating a <see cref="EnergyTypes.SegmentOrthogonality"/>-based <see cref="GP.Energy"/>.
    /// </summary>
    public class Comp_SegmentOrthogonality : GH_Kernel.GH_Component
    {
        ...
        protected override void SolveInstance(GH_Kernel.IGH_DataAccess DA)
        {
            ...
            EnergyTypes.SegmentOrthogonality energyType = new EnergyTypes.SegmentOrthogonality(components);
